...
public class LexiqueFactory {
	...
	public static final String KEY_LexiqueName = "inter.cicada.lexique.name";

	private ICicadaPropertes sigaleProperties;
	...
	public LexiqueFactory(ICicadaPropertes sigaleProperties2, ILogListener logListener2) {
